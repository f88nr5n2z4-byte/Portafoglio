...
function range(start){const m=new Date(start+'T12:00:00'),k=(m.getDay()+6)%7;m.setDate(m.getDate()-k);const e=new Date(m);e.setDate(m.getDate()+20);return[from=iso(m),to=iso(e)]}
