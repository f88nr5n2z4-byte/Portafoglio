(()=>{
 ...
 function mount(){
   ...
   if(daily.dataset.week!==w.dates[0]){selectedDay=0;daily.dataset.week=w.dates[0]}
   renderDaily(daily,w);
 }
 const obs=new MutationObserver(()=>setTimeout(mount,0));obs.observe(document.documentElement,{subtree:true,childList:true});setTimeout(mount,80);
